...
`.mermaid .nodes>:nth-child(2) | @viewbox .nodes>:nth-child(2) | @viewbox .nodes>:nth-child(3) | @viewbox svg`

<Anim spec=".mermaid .nodes>:nth-child(2) | @viewbox .nodes>:nth-child(2) | @viewbox .nodes>:nth-child(3) | @viewbox svg">

# `<Anim>` mermaid (via <strong>SVG</strong>)
